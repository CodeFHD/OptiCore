...
def _get_default_info():
    ...
    surf_defaults['surftype'] = None
    surf_defaults['isstop'] = False
    surf_defaults['radiusX'] = None
    surf_defaults['kX'] = None
    surf_defaults['AX'] = []
    surf_defaults['radiusY'] = None
    surf_defaults['kY'] = None
    surf_defaults['AY'] = []
    surf_defaults['CT'] = None
    surf_defaults['hasglass'] = False
    surf_defaults['ismirror'] = False
    surf_defaults['outline_shape'] = 'circular'
    surf_defaults['glass'] = None
    surf_defaults['rCA'] = None
    surf_defaults['rCA_short'] = None
    surf_defaults['lrad'] = None

    return surf_defaults

def _parse_STANDARD(surflines):
    surf_info = _get_default_info()

    for line in surflines:
        if line.startswith('STOP'):
            surf_info['isstop'] = True
...
def _parse_EVENASPH(surflines):
    pass

def _parse_BICONICX(surflines):
    pass

def _parse_TOROIDAL(surflines):
    pass
"""
