...
from .elements import OBJECT_OT_add_lens, OBJECT_OT_add_sqlens, OBJECT_OT_add_mirror
from .optomech import OBJECT_OT_add_table
...
classes = (OBJECT_OT_add_lens, OBJECT_OT_add_sqlens, OBJECT_OT_add_mirror, OBJECT_OT_add_table)
